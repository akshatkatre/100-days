...
def purchase(m_value: int):
    try:
        ...
        print("buyPortal element not found...")
    ...
    try:
        ...
        print('buyAlchmy element not found...')
    except StaleElementReferenceException:
        print("buyAlchmy element not found...")
    ...
    try:
        ...
        print("buyShipment element not found...")
    except StaleElementReferenceException:
        print("buyShipment element not found...")
    ...
    try:
        ...
        print("buyMine element not found...")
    except StaleElementReferenceException:
        print("buyMine element not found...")
    ...
    try:
        ...
        print('buyFactory element not found...')
    except StaleElementReferenceException:
        print("buyFactory element not found...")
    ...
    try:
        ...
        print('buyGrandma element not found...')
    except StaleElementReferenceException:
        print("buyGrandma element not found...")
    ...
    try:
        ...
        print('buyCursor element not found...')
    except StaleElementReferenceException:
        print("buyCursor element not found...")
